...
//         {/*Dsiplaying small images below main image*/}
//         <div className="mb-2 small-images-container">
//           {ad.images.map((image, i) => (
//             <div
...
//   // Get the first 6 images or all images if less than 6
//   const smallImages = ad?.images.slice(0, 6) || [];

//   // Get the remaining images if there are more than 6 and "View More" is clicked
//   const extraImages = showAllImages ? ad?.images.slice(6) : [];

//   const handleViewMore = () => {
//     setShowAllImages(true);
//   };

//   // Push the extra images into the main images array if "View More" is clicked
//   const images = showAllImages ? [...smallImages, ...extraImages] : smallImages;
...
//             </div>
//           ))}
//           {ad.images.length > 6 && !showAllImages && (
...
//   const images = showAllImages ? ad?.images : ad?.images.slice(0, 6) || [];
...
//         {/*Dsiplaying small images below main image*/}
//         <div className="mb-2 small-images-container">
//           {ad.images.slice(0, 6).map((image, i) => (
//             <div
//               className={`small-image ${idx === i ? "active" : ""}`}
//               key={i}
//               onClick={() => setIdx(i)}
